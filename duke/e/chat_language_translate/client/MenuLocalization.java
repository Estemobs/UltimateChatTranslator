...
public enum MenuLocalization {
   TITLE(Map.ofEntries(
      Map.entry(ENGLISH, "Ultimate Chat Translator — Settings"),
      Map.entry(FRENCH, "Ultimate Chat Translator — Paramètres"),
      Map.entry(TURKISH, "Ultimate Chat Translator — Ayarlar"),
      Map.entry(GERMAN, "Ultimate Chat Translator — Einstellungen"),
      Map.entry(SPANISH, "Ultimate Chat Translator — Configuración"),
      Map.entry(RUSSIAN, "Ultimate Chat Translator — Настройки"),
      Map.entry(JAPANESE, "Ultimate Chat Translator — 設定"),
      Map.entry(CHINESE, "Ultimate Chat Translator — 设置"),
      Map.entry(KOREAN, "Ultimate Chat Translator — 설정"),
      Map.entry(ITALIAN, "Ultimate Chat Translator — Impostazioni"),
      Map.entry(PORTUGUESE, "Ultimate Chat Translator — Configurações")
   )),
